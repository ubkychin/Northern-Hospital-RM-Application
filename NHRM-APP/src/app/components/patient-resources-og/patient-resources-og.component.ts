...
@Component({
  selector: 'app-patient-resources-og',
  templateUrl: './patient-resources-og.component.html',
  styleUrls: ['./patient-resources-og.component.css']
})
export class PatientResourcesOgComponent implements OnInit {

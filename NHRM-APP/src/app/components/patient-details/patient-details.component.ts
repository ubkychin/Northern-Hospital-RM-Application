...
export class PatientDetailsComponent implements OnInit {
  ...
  getPainFeeling() {
    switch (this.conditionDetails.myDrainage.painScore) {
      case 5: this.pain = "No Pain";
        break;
      case 4: this.pain = "Mild";
        break;
      case 3: this.pain = "Moderate";
        break;
      case 2: this.pain = "Severe";
        break;
      case 1: this.pain = "Worst Possible";
    }
  }

  getBreathFeeling() {
    switch (this.conditionDetails.myDrainage.breathScore) {
